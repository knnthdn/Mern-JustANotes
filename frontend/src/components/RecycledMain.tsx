...
function RecycledMain() {
  ...
  return (
    <main className="flex h-full overflow-auto px-4 py-2 mt-2 sm:px-8 md:px-14 lg:border-2 lg:border-gray-400 lg:p-8 lg:my-2 lg:mx-14 lg:rounded-xl lg:bg-gray-50 xl:mx-36 2xl:mx-40 xxl:mx-80 xxl:px-16 relative">
